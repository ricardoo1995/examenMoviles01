...
class MedicamentoAdapter(private val medicamentoList: List<Medicamento>) : RecyclerView.Adapter<MedicamentoAdapter.MyViewHolder>() {
    ...
    inner class MyViewHolder(view: View) : RecyclerView.ViewHolder(view), View.OnCreateContextMenuListener {
        ...
        init {
            ...
            numeroPastillas = view.findViewById(R.id.txt_3) as TextView
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.fechaCaducidad.text = medicamento.fechaCaducidad
        holder.numeroPastillas.text = medicamento.numeroPastillas.toString()
        holder.medicamento = medicamento
        holder.detalles.setOnClickListener{
            v: View ->
            val intent = Intent(v.context, DetailsMedicamentosActivity::class.java)
